...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ros_2fstd_5fmsgs_2fFloat32MultiArray_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ros_2fstd_5fmsgs_2fFloat32MultiArray_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ros_2fstd_5fmsgs_2fFloat32MultiArray_2eproto
...
struct TableStruct_ros_2fstd_5fmsgs_2fFloat32MultiArray_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ros_2fstd_5fmsgs_2fFloat32MultiArray_2eproto;
namespace ros {
namespace std_msgs {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::ros::std_msgs::Float32MultiArray* Arena::CreateMaybeMessage<::ros::std_msgs::Float32MultiArray>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ros {
namespace std_msgs {
...
class Float32MultiArray final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ros.std_msgs.Float32MultiArray) */ {
 public:
  inline Float32MultiArray() : Float32MultiArray(nullptr) {}
  ~Float32MultiArray() override;
  explicit constexpr Float32MultiArray(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  Float32MultiArray* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ros.std_msgs.Float32MultiArray";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:ros.std_msgs.Float32MultiArray)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_ros_2fstd_5fmsgs_2fFloat32MultiArray_2eproto;
};
// ===================================================================
...
inline const ::ros::std_msgs::MultiArrayLayout& Float32MultiArray::_internal_layout() const {
...
inline const ::ros::std_msgs::MultiArrayLayout& Float32MultiArray::layout() const {
  // @@protoc_insertion_point(field_get:ros.std_msgs.Float32MultiArray.layout)
...
inline void Float32MultiArray::unsafe_arena_set_allocated_layout(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ros.std_msgs.Float32MultiArray.layout)
}
inline ::ros::std_msgs::MultiArrayLayout* Float32MultiArray::release_layout() {
...
inline ::ros::std_msgs::MultiArrayLayout* Float32MultiArray::unsafe_arena_release_layout() {
  // @@protoc_insertion_point(field_release:ros.std_msgs.Float32MultiArray.layout)
  
  ::ros::std_msgs::MultiArrayLayout* temp = layout_;
  layout_ = nullptr;
  return temp;
}
inline ::ros::std_msgs::MultiArrayLayout* Float32MultiArray::_internal_mutable_layout() {
...
inline ::ros::std_msgs::MultiArrayLayout* Float32MultiArray::mutable_layout() {
  ::ros::std_msgs::MultiArrayLayout* _msg = _internal_mutable_layout();
  // @@protoc_insertion_point(field_mutable:ros.std_msgs.Float32MultiArray.layout)
  return _msg;
}
inline void Float32MultiArray::set_allocated_layout(::ros::std_msgs::MultiArrayLayout* layout) {
  ...
  layout_ = layout;
  // @@protoc_insertion_point(field_set_allocated:ros.std_msgs.Float32MultiArray.layout)
}
...
inline float Float32MultiArray::data(int index) const {
  // @@protoc_insertion_point(field_get:ros.std_msgs.Float32MultiArray.data)
  return _internal_data(index);
}
inline void Float32MultiArray::set_data(int index, float value) {
  data_.Set(index, value);
  // @@protoc_insertion_point(field_set:ros.std_msgs.Float32MultiArray.data)
}
...
inline void Float32MultiArray::add_data(float value) {
  ...
  // @@protoc_insertion_point(field_add:ros.std_msgs.Float32MultiArray.data)
}
...
Float32MultiArray::data() const {
  // @@protoc_insertion_point(field_list:ros.std_msgs.Float32MultiArray.data)
...
Float32MultiArray::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:ros.std_msgs.Float32MultiArray.data)
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ros_2fstd_5fmsgs_2fFloat32MultiArray_2eproto
