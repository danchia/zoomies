...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ros_2fgeometry_5fmsgs_2fAccel_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ros_2fgeometry_5fmsgs_2fAccel_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ros_2fgeometry_5fmsgs_2fAccel_2eproto
...
struct TableStruct_ros_2fgeometry_5fmsgs_2fAccel_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ros_2fgeometry_5fmsgs_2fAccel_2eproto;
namespace ros {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::ros::geometry_msgs::Accel* Arena::CreateMaybeMessage<::ros::geometry_msgs::Accel>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ros {
namespace geometry_msgs {
...
class Accel final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ros.geometry_msgs.Accel) */ {
 public:
  ...
  Accel* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ros.geometry_msgs.Accel";
  }
  protected:
 ...
 private:
  ...
  friend struct ::TableStruct_ros_2fgeometry_5fmsgs_2fAccel_2eproto;
};
// ===================================================================
...
inline const ::ros::geometry_msgs::Vector3& Accel::_internal_linear() const {
...
inline const ::ros::geometry_msgs::Vector3& Accel::linear() const {
  // @@protoc_insertion_point(field_get:ros.geometry_msgs.Accel.linear)
...
inline void Accel::unsafe_arena_set_allocated_linear(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ros.geometry_msgs.Accel.linear)
}
inline ::ros::geometry_msgs::Vector3* Accel::release_linear() {
...
inline ::ros::geometry_msgs::Vector3* Accel::unsafe_arena_release_linear() {
  // @@protoc_insertion_point(field_release:ros.geometry_msgs.Accel.linear)
  
  ::ros::geometry_msgs::Vector3* temp = linear_;
  linear_ = nullptr;
  return temp;
}
inline ::ros::geometry_msgs::Vector3* Accel::_internal_mutable_linear() {
...
inline ::ros::geometry_msgs::Vector3* Accel::mutable_linear() {
  ::ros::geometry_msgs::Vector3* _msg = _internal_mutable_linear();
  // @@protoc_insertion_point(field_mutable:ros.geometry_msgs.Accel.linear)
  return _msg;
}
inline void Accel::set_allocated_linear(::ros::geometry_msgs::Vector3* linear) {
  ...
  linear_ = linear;
  // @@protoc_insertion_point(field_set_allocated:ros.geometry_msgs.Accel.linear)
}
...
inline const ::ros::geometry_msgs::Vector3& Accel::_internal_angular() const {
  const ::ros::geometry_msgs::Vector3* p = angular_;
  return p != nullptr ? *p : reinterpret_cast<const ::ros::geometry_msgs::Vector3&>(
      ::ros::geometry_msgs::_Vector3_default_instance_);
}
inline const ::ros::geometry_msgs::Vector3& Accel::angular() const {
  // @@protoc_insertion_point(field_get:ros.geometry_msgs.Accel.angular)
...
inline void Accel::unsafe_arena_set_allocated_angular(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ros.geometry_msgs.Accel.angular)
}
inline ::ros::geometry_msgs::Vector3* Accel::release_angular() {
...
inline ::ros::geometry_msgs::Vector3* Accel::unsafe_arena_release_angular() {
  // @@protoc_insertion_point(field_release:ros.geometry_msgs.Accel.angular)
  
  ::ros::geometry_msgs::Vector3* temp = angular_;
  angular_ = nullptr;
  return temp;
}
inline ::ros::geometry_msgs::Vector3* Accel::_internal_mutable_angular() {
...
inline ::ros::geometry_msgs::Vector3* Accel::mutable_angular() {
  ::ros::geometry_msgs::Vector3* _msg = _internal_mutable_angular();
  // @@protoc_insertion_point(field_mutable:ros.geometry_msgs.Accel.angular)
  return _msg;
}
inline void Accel::set_allocated_angular(::ros::geometry_msgs::Vector3* angular) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(angular_);
  }
  ...
  angular_ = angular;
  // @@protoc_insertion_point(field_set_allocated:ros.geometry_msgs.Accel.angular)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ros_2fgeometry_5fmsgs_2fAccel_2eproto
