...
protoc -I=$PROTO_PATH --python_out=ros_msgs  $PROTO_PATH/ros/**/*.proto $PROTO_PATH/ros/*.proto
protoc -I=$PROTO_PATH $PROTO_PATH/ros/**/*.proto $PROTO_PATH/ros/*.proto --include_imports --descriptor_set_out=ros_msgs/descriptor.bin
